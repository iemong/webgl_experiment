...
},{"../../modules/_core":14,"../../modules/es6.object.define-property":69}],6:[function(require,module,exports){
...
},{"./_descriptors":17,"./_export":20,"./_object-dp":42}],70:[function(require,module,exports){
...
},{"./_global":23,"./_hide":25,"./_iterators":37,"./_wks":66,"./es6.array.iterator":68}],76:[function(require,module,exports){
'use strict';
...
exports.loadColladaModel = loadColladaModel;
exports.loadFBXModel = loadFBXModel;
...
function loadObjModel() {
  // dds形式のテクスチャを読み込むために設定を追加（今回は無視してもらって大丈夫です）
  THREE.Loader.Handlers.add(/\.dds$/i, new THREE.DDSLoader());

  // .mtlをロード
  var loadMTL = function loadMTL() {
  ...
  // objをロード
  var loadOBJ = function loadOBJ(materials) {
    var objLoader = new THREE.OBJLoader();
    objLoader.setPath('models/obj-mtl/');
    // materialsを読み込みきった後にsetMaterialsをするといい感じにmeshに紐付けてくれる
  ...
  return loadMTL().then(loadOBJ).then(createWrapperMesh);
}
...
function loadColladaModel() {
  var loadCollada = function loadCollada() {
    var colladaLoader = new THREE.ColladaLoader();
    return new _promise2.default(function (resolve) {
      colladaLoader.options.convertUpAxis = true;
      colladaLoader.load('models/collada/monster.dae', function (obj) {
        var mesh = obj.scene;
  ...
  return loadCollada().then(createWrapperMesh);
}

function loadFBXModel() {
  var loadFBX = function loadFBX() {
    var fbxLoader = new THREE.FBXLoader();
    return new _promise2.default(function (resolve) {
      fbxLoader.load('models/fbx/xsi_man_skinning.fbx', function (obj) {
  ...
  return loadFBX().then(createWrapperMesh);
}

//------------------------------------------------------------------------------------------
// コンバーターでfbxをjsonに変換したものを使ってみる
// アニメーションつき
...
function loadJSONModel() {
  var loadJSON = function loadJSON() {
    ...
    return new _promise2.default(function (resolve) {
      sceneLoader.load('models/json/xsi_man_skinning.json', function (obj) {
        var geometries = obj.geometries,
            materials = obj.materials;

        var mesh = new THREE.SkinnedMesh(geometries['Geometry_117_XSIMan:Man'], materials['Biped1']);
        mesh.material.skinning = true;

        var clip = THREE.AnimationClip.parseAnimation({
          hierarchy: mesh.geometry.animation_hierarchy
        }, mesh.geometry.bones);
  ...
  return loadJSON().then(createWrapperMesh);
}
...
function loadGLTFModel() {
  var loadGLTF = function loadGLTF() {
    var gltfLoader = new THREE.GLTF2Loader();
    return new _promise2.default(function (resolve) {
      gltfLoader.load('models/gltf/Monster.gltf', function (obj) {
  ...
  return loadGLTF().then(createWrapperMesh);
}
...
// ロードしたモデルをobject3Dに追加したものをsceneに追加するように
// 回転や位置の細かい調整は入れ子にしたmeshに変更をあてる
function createWrapperMesh(mesh) {
  var wrapperMesh = new THREE.Object3D();
  wrapperMesh.add(mesh);
  return mesh;
}

},{"babel-runtime/core-js/promise":2}],77:[function(require,module,exports){
'use strict';
...
var _modelLoaders = require('./modelLoaders');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Practice_05 = function () {
    function Practice_05() {
        (0, _classCallCheck3.default)(this, Practice_05);
    ...
    (0, _createClass3.default)(Practice_05, [{
        key: 'init',
        value: function init() {
            this.initRenderer();
            this.initScene();
...
exports.default = new Practice_05();

},{"./modelLoaders":76,"babel-runtime/helpers/classCallCheck":3,"babel-runtime/helpers/createClass":4}],78:[function(require,module,exports){
'use strict';

var _practice_ = require('./lib/practice_05');

var _practice_2 = _interopRequireDefault(_practice_);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./lib/practice_05":77}]},{},[78]);
